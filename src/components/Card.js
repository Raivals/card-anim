  ...
  return (
    ...
    <div style={{ perspective: 2000 }}>
      ...
      <motion.div
        ...
        className="w-[425px] min-h-[600px] bg-[#e4dfdc] rounded-[30px] border-[4px] border-white px-[40px] py-[24px] cursor-grab relative"
      >
        {/* card logo */}
        <div className="mb-6">
          <img src={LogoImg} alt="nike logo" />
        </div>
        {/* card title */}
        ...
        <div className="flex items-center gap-x-[20px] mb-12">
          <button
            className="bg-[#2d2b2c] text-white text-base font-medium py-[16px] px-[40px] rounded-lg"
            type="btn"
          >
            Add to Bag
          </button>
          <div className="text-[24px] font-bold text-[#000000]">120€</div>
        </div>
        {/* colors */}
        ...
        >
          <img src={NikeImg} alt="nike basket" draggable="false" />
        </motion.div>
      </motion.div>
    </div>
  )
